# -*- coding: utf-8 -*-
"""
Created on Tue Jun 29 23:44:17 2021
...
class auxdata:
    def __init__(self,x,wind_avg,wind_type):
        ...
        self.A_scaled=np.array([[0],[0],[0],[self.omega_max/2],[0],[0],[0],[0.6807/2 ],[0.5*4.18e6]])
        self.B_scaled=np.diag([3,3,0.1745,self.omega_max/2,100,100,np.deg2rad(6.3),0.6807/2, 0.5*4.18e6])
        self.C_scaled=np.zeros((2,1))
        self.D_scaled=np.diag([1e5,1e-2])
