# -*- coding: utf-8 -*-
"""
Created on Mon Jul  5 12:10:43 2021
...
def obj_inner(x,wind_avg,wind_type):
    #%% input data
    """--------------------------Input data-----------------------"""
...
# define the control
    ...
    #plot(time_vec_sol,q1_vec_scaled_sol,'o')
    #plot(time_vec_sim,q1_vec_scaled_sim)

    objective_inner=obj_vec_sim[-1]*1e9/time_vec_sim[-1]
