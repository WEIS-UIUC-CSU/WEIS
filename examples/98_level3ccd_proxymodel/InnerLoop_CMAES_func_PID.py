# -*- coding: utf-8 -*-
"""
Created on Mon Jul 26 13:42:55 2021

@author: bayat2
"""
import numpy as np
from obj_inner_func_PID import obj_inner_PID
from obj_inner_test_func import obj_inner_test

def Innerloop_CMAES_PID(x_scaled,i_speed,Outer_loop_params):
    ...
    obj_inner_val=obj_inner_PID(x,wind_avg,wind_type)
