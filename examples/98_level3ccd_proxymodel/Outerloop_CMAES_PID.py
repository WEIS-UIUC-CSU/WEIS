# -*- coding: utf-8 -*-
"""
Created on Mon Jul 26 12:45:59 2021

@author: bayat2
"""

import numpy as np
from CMAES_func_PID import CMAES_Func_PID
...
obj_func=[]
[x_scaled_opt,fmin,x_opt_vector,f_opt_vector,x_total_vec,f_total_vec]=CMAES_Func_PID(obj_func,N,funcval_stop_outerloop,lambda_pop,x0,OLP_instance)
...
filename ='CCD_PID_Results_N4_WW_Ctr90_lambda50_fval_2000.pkl'
